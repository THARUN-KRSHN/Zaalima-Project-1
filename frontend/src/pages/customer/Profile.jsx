...
const CORE_PROFILE_SCHEMA_REGISTRY = {
    labels: {
        ...
        pageSubtitle: "View and update your personal information and security settings.",
        backActionLabel: "Back to Catalog",
        roleBadgeText: "Account Role",
        ...
        updatePassBtnText: "Update Password"
    },
    ...
    accountOverviewStats: [
        { label: "Orders Placed", value: "14 Orders" },
        { label: "Wishlist Items", value: "29 Items" },
        { label: "Saved Addresses", value: "2 Addresses" }
    ]
};
